...
<html>
	...
	<body>
							...
							<!-- Banner -->
								<section id="banner">
									...
									<span class="image object">
										<img src="<?php echo base_url(); ?>assets/front/images/pic10.jpg" alt="" />
									</span>
								</section>
		...
		<!-- Scripts -->
			...
			<script src="<?php echo base_url(); ?>assets/front/assets/js/skel.min.js"></script>
			<script src="<?php echo base_url(); ?>assets/front/assets/js/util.js"></script>
